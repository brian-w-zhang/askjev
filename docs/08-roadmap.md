...
| 2026-09-24 | Main view is a **3D nebula** (`07-ui.md`): every node and every displayable question drawn as stars; detail on approach; one search/ask box, "I'm feeling lucky", and search as a journey to the result (green is Jev's color only). High-volume Machine templates (≥100 instances) become topic nodes |
